...
def _build_direct_alignment_relations(payload: dict) -> list[dict]:
    ...
    return [
        ...
        {
            "relation_type": "ASSESSES_SOLUTION_PLAN",
            ...
            "relationship_properties": rel_props,
            "require_existing_target": True,
            "source_entity_type": "AlignmentAssessment",
            "source_key": "alignmentAssessmentId",
            "source_id": rel_props["alignmentAssessmentId"],
        },
        {
            "relation_type": "ASSESSES_IMPLEMENTATION_PLAN",
